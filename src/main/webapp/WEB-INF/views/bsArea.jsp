...
<div id="mainBody">
    ...
    <div>
        ...
        <table id="treeTable" class="table table-striped table-bordered table-condensed">
            <tr>
                <th>校区编码</th><th>校区名称</th><th>校区描述</th><th>是否有效</th><th>修改时间</th>
            </tr>
        ...
        <tr>
            <td colspan="6" align="center" bgcolor="#5BA8DE"><h3>共${page.totalRecords}条记录 共${page.totalPages}页
                ...
                <a href="${path}/a/getBSArea?pageNo=${page.topPageNo}&schoolCode=${searchMap["schoolCode"]}&schoolName=${searchMap["schoolName"]}&modify=${searchMap["modify"]}"><input
                        type="button" name="fristPage" value="首页" class="btn btn-primary btn-xs"/></a>
                <c:choose>
                    <c:when test="${page.pageNo!=1}">

                        <a href="${path}/a/getBSArea?pageNo=${page.previousPageNo}&schoolCode=${searchMap["schoolCode"]}&schoolName=${searchMap["schoolName"]}&modify=${searchMap["modify"]} "><input
                ...
                <c:choose>
                    <c:when test="${page.pageNo != page.totalPages}">
                        <a href="${path}/a/getBSArea?pageNo=${page.nextPageNo} &schoolCode=${searchMap["schoolCode"]}&schoolName=${searchMap["schoolName"]}&modify=${searchMap["modify"]}"><input
                ...
                <a href="${path}/a/getBSArea?pageNo=${page.bottomPageNo}&schoolCode=${searchMap["schoolCode"]}&schoolName=${searchMap["schoolName"]}&modify=${searchMap["modify"]} "><input
