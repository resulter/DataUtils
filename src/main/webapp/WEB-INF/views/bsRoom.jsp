...
<div class="box">
    <ul id="nav">
        ...
        <li><A  class="hover" href="/a/getBSRoom" >BS_Room</A></li>
...
<div id="mainBody">
    ...
    <br/>
    <form action="/a/getBSRoom" name="search" method="get" class="form-horizontal">
        &nbsp;&nbsp;<label for="sName"> 教室名称 </label>&nbsp;&nbsp;
        <input type="text" id="sName" name="sName" value="${searchMap["sName"]}">
        &nbsp;&nbsp;<label for="sAddress"> 地址 </label>&nbsp;&nbsp;
        <input type="text" id="sAddress" name="sAddress" value="${searchMap["sAddress"]}">
    ...
    <div>
        <table id="treeTable" class="table table-striped table-bordered table-condensed">
            <tr><th>教室名称</th><th>地址</th><th>修改时间</th></tr>
        ...
        <tr>
            <td colspan="6" align="center" bgcolor="#5BA8DE"><h3>共${page.totalRecords}条记录 共${page.totalPages}页 当前第${page.pageNo}页</h3><br>
                ...
                <a href="${path}/a/getBSRoom?pageNo=${page.topPageNo}&sCode=${searchMap["sCode"]}&sName=${searchMap["sName"]}&sAddress=${searchMap["sAddress"]}"><input type="button" name="fristPage" value="首页" class="btn btn-primary btn-xs" /></a>
                <c:choose>
                    <c:when test="${page.pageNo!=1}">

                        <a href="${path}/a/getBSRoom?pageNo=${page.previousPageNo}&sCode=${searchMap["sCode"]}&sName=${searchMap["sName"]}&sAddress=${searchMap["sAddress"]}"><input type="button" name="previousPage" value="上一页" class="btn btn-primary btn-xs" /></a>
                ...
                <c:choose>
                    <c:when test="${page.pageNo != page.totalPages}">
                        <a href="${path}/a/getBSRoom?pageNo=${page.nextPageNo}&sCode=${searchMap["sCode"]}&sName=${searchMap["sName"]}&sAddress=${searchMap["sAddress"]}"><input type="button" name="nextPage" value="下一页" class="btn btn-primary btn-xs" /></a>
                    </c:when>
                    <c:otherwise>
                ...
                <a href="${path}/a/getBSRoom?pageNo=${page.bottomPageNo}&sCode=${searchMap["sCode"]}&sName=${searchMap["sName"]}&sAddress=${searchMap["sAddress"]}"><input type="button" name="lastPage" value="尾页" class="btn btn-primary btn-xs" /></a>
            </td>
        </tr>
    </div>
</div>
